...
Figure \ref{fig:histogram_joint} (\textit{Bottom left}), illustrates the likelihood function, Equation \ref{eq:ch5:discrete_likelihoood}, 
...
Figure \ref{fig:maringal_joint_example_v2} illustrates the evolution of the \textbf{un-normalised} MLMF joint distribution ${P(A_t,O,Y_{0:t}|u_{1:t})}$, Equation  \ref{eq:ch5:mlmf_filter_conditional}.
